...
param_scheduler = [
    dict(begin=0, by_epoch=False, end=2000, eta_min=0.0001, power=0.9, type="PolyLR"),
]
...
train_cfg = dict(
    _scope_="mmseg", max_iters=2000, type="IterBasedTrainLoop", val_interval=1000
)
...
work_dir = "work_dirs/phase1_run_b_ce_aug"
