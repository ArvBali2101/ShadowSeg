...
param_scheduler = [
    dict(begin=0, by_epoch=False, end=1, eta_min=0.0001, power=0.9, type="PolyLR"),
]
...
train_cfg = dict(
    _scope_="mmseg", max_iters=1, type="IterBasedTrainLoop", val_interval=100
)
...
work_dir = "work_dirs/_smoke_deeplabv3plus_r50_iter1"
